...
class MNISTDataModule(pl.LightningDataModule):
	...
	def __init__(self):
		super().__init__()
		self.transform = torchvision.transforms.Compose([torchvision.transforms.Lambda(lambda x: x / 255),
	...
	def train_dataloader(self):
		return DataLoader(self.train_data, batch_size=128, shuffle=True, collate_fn=numpy_collate)
